//
//  YourTripsDViewController.swift
//  Quadrant
//
...
class YourTripsDViewController: UIViewController {
    ...
    private var viewModel = YourTripsDViewModel()
...
extension YourTripsDViewController: UITableViewDelegate, UITableViewDataSource {
